...
JSBool js_cocos2dx_studio_CCArmatureAnimation_setScriptObjectDict(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
...
JSBool js_cocos2dx_studio_CCArmatureAnimation_getScriptObjectDict(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::extension::CCArmatureAnimation* cobj = (cocos2d::extension::CCArmatureAnimation *)(proxy ? proxy->ptr : NULL);
	JSB_PRECONDITION2( cobj, cx, JS_FALSE, "Invalid Native Object");
	if (argc == 0) {
		cocos2d::CCDictionary* ret = cobj->getScriptObjectDict();
		jsval jsret;
...
void js_register_cocos2dx_studio_CCArmatureAnimation(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("setScriptObjectDict", js_cocos2dx_studio_CCArmatureAnimation_setScriptObjectDict, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		...
		JS_FN("getScriptObjectDict", js_cocos2dx_studio_CCArmatureAnimation_getScriptObjectDict, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
JSBool js_cocos2dx_studio_CCArmatureDataManager_destroyInstance(JSContext *cx, uint32_t argc, jsval *vp)
{
	if (argc == 0) {
...
JSBool js_cocos2dx_studio_CCArmatureDataManager_getInstance(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	...
	do {
		if (argc == 0) {
			cocos2d::extension::CCArmatureDataManager* ret = cocos2d::extension::CCArmatureDataManager::getInstance();
			jsval jsret;
			do {
				if (ret) {
...
void js_register_cocos2dx_studio_CCArmatureDataManager(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec st_funcs[] = {
		...
		JS_FN("destroyInstance", js_cocos2dx_studio_CCArmatureDataManager_destroyInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getInstance", js_cocos2dx_studio_CCArmatureDataManager_getInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
...
JSBool js_cocos2dx_studio_Widget_setScriptObjectDict(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
...
JSBool js_cocos2dx_studio_Widget_getScriptObjectDict(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	js_proxy_t *proxy = jsb_get_js_proxy(obj);
	cocos2d::ui::Widget* cobj = (cocos2d::ui::Widget *)(proxy ? proxy->ptr : NULL);
...
void js_register_cocos2dx_studio_Widget(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("setScriptObjectDict", js_cocos2dx_studio_Widget_setScriptObjectDict, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		...
		JS_FN("getScriptObjectDict", js_cocos2dx_studio_Widget_getScriptObjectDict, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
JSBool js_cocos2dx_studio_GUIReader_widgetFromBinaryFile(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
...
{
	if (argc == 0) {
		cocos2d::extension::GUIReader::destroyInstance();
		JS_SET_RVAL(cx, vp, JSVAL_VOID);
		return JS_TRUE;
	}
	JS_ReportError(cx, "wrong number of arguments");
...
JSBool js_cocos2dx_studio_GUIReader_getInstance(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	do {
		if (argc == 0) {
			cocos2d::extension::GUIReader* ret = cocos2d::extension::GUIReader::getInstance();
			jsval jsret;
			do {
				if (ret) {
...
{
	if (argc == 0) {
		cocos2d::extension::SceneReader::destroyInstance();
		JS_SET_RVAL(cx, vp, JSVAL_VOID);
		return JS_TRUE;
	}
	JS_ReportError(cx, "wrong number of arguments");
...
JSBool js_cocos2dx_studio_SceneReader_getInstance(JSContext *cx, uint32_t argc, jsval *vp)
{
	...
	do {
		if (argc == 0) {
			cocos2d::extension::SceneReader* ret = cocos2d::extension::SceneReader::getInstance();
			jsval jsret;
			do {
				if (ret) {
...
JSBool js_cocos2dx_studio_ActionObject_initWithBinary(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	...
	JSB_PRECONDITION2( cobj, cx, JS_FALSE, "Invalid Native Object");
	if (argc == 3) {
		cocos2d::extension::CocoLoader* arg0;
		cocos2d::extension::stExpCocoNode* arg1;
		cocos2d::CCObject* arg2;
		do {
			if (!argv[0].isObject()) { ok = JS_FALSE; break; }
			js_proxy_t *proxy;
			JSObject *tmpObj = JSVAL_TO_OBJECT(argv[0]);
			proxy = jsb_get_js_proxy(tmpObj);
			arg0 = (cocos2d::extension::CocoLoader*)(proxy ? proxy->ptr : NULL);
			JSB_PRECONDITION2( arg0, cx, JS_FALSE, "Invalid Native Object");
		} while (0);
		...
		do {
			...
			proxy = jsb_get_js_proxy(tmpObj);
			arg2 = (cocos2d::CCObject*)(proxy ? proxy->ptr : NULL);
...
JSBool js_cocos2dx_studio_ActionManager_initWithBinary(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	JSObject *obj = JS_THIS_OBJECT(cx, vp);
	...
	if (argc == 4) {
		...
		cocos2d::extension::CocoLoader* arg2;
		cocos2d::extension::stExpCocoNode* arg3;
		std::string arg0_tmp; ok &= jsval_to_std_string(cx, argv[0], &arg0_tmp); arg0 = arg0_tmp.c_str();
		do {
			if (!argv[1].isObject()) { ok = JS_FALSE; break; }
			js_proxy_t *proxy;
		...
		do {
			...
			JSObject *tmpObj = JSVAL_TO_OBJECT(argv[2]);
			proxy = jsb_get_js_proxy(tmpObj);
			arg2 = (cocos2d::extension::CocoLoader*)(proxy ? proxy->ptr : NULL);
			JSB_PRECONDITION2( arg2, cx, JS_FALSE, "Invalid Native Object");
		} while (0);
		#pragma warning NO CONVERSION TO NATIVE FOR stExpCocoNode*;
		JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
...
JSBool js_cocos2dx_studio_ActionManager_destroyInstance(JSContext *cx, uint32_t argc, jsval *vp)
{
	if (argc == 0) {
		cocos2d::extension::ActionManager::destroyInstance();
		JS_SET_RVAL(cx, vp, JSVAL_VOID);
		return JS_TRUE;
	}
	JS_ReportError(cx, "wrong number of arguments");
...
JSBool js_cocos2dx_studio_ActionManager_getInstance(JSContext *cx, uint32_t argc, jsval *vp)
{
	jsval *argv = JS_ARGV(cx, vp);
	JSBool ok = JS_TRUE;
	...
	do {
		if (argc == 0) {
			cocos2d::extension::ActionManager* ret = cocos2d::extension::ActionManager::getInstance();
			jsval jsret;
			do {
				if (ret) {
...
void js_register_cocos2dx_studio_ActionManager(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("initWithBinary", js_cocos2dx_studio_ActionManager_initWithBinary, 4, JSPROP_PERMANENT | JSPROP_ENUMERATE),
	...
	static JSFunctionSpec st_funcs[] = {
		...
		JS_FN("destroyInstance", js_cocos2dx_studio_ActionManager_destroyInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getInstance", js_cocos2dx_studio_ActionManager_getInstance, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
