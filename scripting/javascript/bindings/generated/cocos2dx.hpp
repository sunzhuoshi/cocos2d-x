...
extern JSClass  *js_cocos2dx_CCCallFuncND_class;
extern JSObject *js_cocos2dx_CCCallFuncND_prototype;

JSBool js_cocos2dx_CCCallFuncND_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCCallFuncND_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCCallFuncND(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCCallFuncND_getClassTypeInfo(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCCallFuncND_execute(JSContext *cx, uint32_t argc, jsval *vp);
...
extern JSClass  *js_cocos2dx_CCClippingNode_class;
extern JSObject *js_cocos2dx_CCClippingNode_prototype;
...
JSBool js_cocos2dx_CCScrollView_getClassTypeInfo(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCHttpRequest_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCHttpRequest_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCHttpRequest(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCHttpRequest_getUrl(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpRequest_setTag(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpRequest_setUrl(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpRequest_getTarget(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpRequest_autorelease(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpRequest_getRequestDataSize(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpRequest_getTag(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpRequest_CCHttpRequest(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *js_cocos2dx_CCHttpResponse_class;
extern JSObject *js_cocos2dx_CCHttpResponse_prototype;

JSBool js_cocos2dx_CCHttpResponse_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCHttpResponse_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCHttpResponse(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCHttpResponse_getErrorBuffer(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpResponse_isSucceed(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpResponse_getResponseCode(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpResponse_autorelease(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpResponse_getHttpRequest(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpResponse_CCHttpResponse(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *js_cocos2dx_CCHttpClient_class;
extern JSObject *js_cocos2dx_CCHttpClient_prototype;

JSBool js_cocos2dx_CCHttpClient_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCHttpClient_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCHttpClient(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCHttpClient_setTimeoutForConnect(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpClient_setTimeoutForRead(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpClient_getTimeoutForConnect(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpClient_send(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpClient_getTimeoutForRead(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpClient_destroyInstance(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCHttpClient_getInstance(JSContext *cx, uint32_t argc, jsval *vp);
#endif
